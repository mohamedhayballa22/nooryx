...
If a SKU’s quantity reaches zero, Nooryx clears all layers for that SKU. The next receive starts a new cost structure. This applies to all three valuation methods, including WAC.
