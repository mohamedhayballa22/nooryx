...
The **SKU Code** and **Name** are required when you first receive inventory. The alerting thresholds give you control over when Nooryx notifies you about stock levels, which we cover in detail in the <Link href="/docs/management/alerts">**Alerting Guide**</Link>.
