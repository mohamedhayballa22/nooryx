      ...
      <div className="relative rounded-xl border border-neutral-200 bg-white p-8 dark:border-neutral-800 dark:bg-neutral-950">
        ...
        <div className="relative mx-auto max-w-2xl z-10">
          ...
          <div className="flex justify-center relative z-20">
            <div className="group relative flex items-center gap-3 rounded-lg border border-neutral-200 bg-white px-5 py-3 shadow-sm transition-all hover:border-neutral-300 dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-neutral-700">
              ...
              {/* Connector dot */}
              <div className="absolute -bottom-1.5 left-1/2 h-2.5 w-2.5 -translate-x-1/2 rounded-full border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-950" />
            </div>
          </div>
          ...
          <div className="mt-8 flex justify-center">
            <div className="flex items-center gap-3 rounded-full border border-neutral-200 bg-neutral-50/80 px-4 py-1.5 text-xs text-neutral-600 backdrop-blur-sm dark:border-neutral-800 dark:bg-neutral-900/80 dark:text-neutral-400">
...
function LocationNode({ name, count }: { name: string; count: number }) {
  return (
    <div className="group relative flex flex-col items-center justify-center rounded-lg border border-neutral-200 bg-white py-5 shadow-[0_2px_8px_rgba(0,0,0,0.02)] transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950">
      {/* Connector dot */}
      <div className="absolute -top-1.5 left-1/2 h-2.5 w-2.5 -translate-x-1/2 rounded-full border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-950" />
