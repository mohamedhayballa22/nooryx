    ...
    <div className="my-8 select-none">
      ...
      <div className="flex items-stretch gap-6">
        ...
        <div className="w-28 flex flex-col items-center justify-center">
          ...
          <div className="w-full aspect-square rounded-xl bg-neutral-100 dark:bg-neutral-800/60 flex flex-col items-center justify-center">
...
export default LedgerStateVisual;
