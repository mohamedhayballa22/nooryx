...
- Receiving stock  
- Positive adjustments during cycle counts (<Link href="/docs/workflows/stock-adjustments">Adjustments</Link>)  
...
- <Link href="/docs/workflows/stock-adjustments">Adjustments</Link> – Correct On Hand counts  
